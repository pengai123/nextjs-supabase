export function DotPattern() {
  return (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-70">
      {/* Create a 6x6 grid of dots with different opacities */}
      {[...Array(6)].map((_, i) =>
        [...Array(6)].map((_, j) => (
          <circle
            key={`${i}-${j}`}
